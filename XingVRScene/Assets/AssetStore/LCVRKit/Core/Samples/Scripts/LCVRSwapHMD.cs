...
public class LCVRSwapHMD : MonoBehaviour
{
	...
	private int hmdIndex = 0; // 0:hacosco dx 1:google cardboard 2:soyan 3:andoer 4:gmyle 5:hacosco(single view)
	...
	private void updateHMD(){
		...
		case 2: name = "Soyan"           ; hmdType = LCVRLens.HMD_TYPE.SOYAN           ; break;
		case 3: name = "Andoer"          ; hmdType = LCVRLens.HMD_TYPE.ANDOER          ; break;
		case 4: name = "GMYLE"           ; hmdType = LCVRLens.HMD_TYPE.GMYLE           ; break;
		case 5: name = "HACOSCO (Single)"; hmdType = LCVRLens.HMD_TYPE.HACOSCO         ; viewMode = LCVRHead.VIEW_MODE.SINGLE; break;
		}
